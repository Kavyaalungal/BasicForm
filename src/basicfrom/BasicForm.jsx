      ...
      <Grid container spacing={5}>
        ...
        <Grid item xs={12} sm={12} md={3}>
          <CCard style={{ width: '100%' }}>
            {/* <CCardHeader style={{
              backgroundColor: ' #5cb435',
              color: 'white',
              padding: 8,
              fontSize: '16px',
              border: '1px solid  #5cb435',
              marginBottom: 2
            ...
            <CCardBody style={{ textAlign: 'center' }}>
              ...
              <Typography
                ...
                sx={{
                  ...
                  alignItems: 'center',
                  marginBottom: 2,
                  color: ' #5cb435 ', // Text color
                  fontWeight: 'bold' // Text weight
                }}
              >
                ID: {userId}
                <IconButton
                  onClick={() => handleEditClick()} // Function to handle the edit click
                // sx={{ marginLeft: 1 }} // Space between text and icon
                >
                  <EditIcon sx={{ color: ' #5cb435 ', marginBottom: '7px' }} /> {/* Icon color */}
                </IconButton>
              </Typography>
              ...
              <label htmlFor="upload-avatar">
                <IconButton component="span">
                  <Avatar
                    ...
                    sx={{ width: 100, height: 100,backgroundColor: ' #60c334 ' }}
                  />
                </IconButton>
              </label>
              ...
              <Box sx={{ marginTop: 2 }}>
                ...
                <label htmlFor="upload-id-proof">
                  <IconButton component="span" sx={{backgroundColor:'#60c334 ',color:'white'}}>
