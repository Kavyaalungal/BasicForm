...
//                 // sx={{ marginLeft: 1 }} 
//                 >
//                   <EditIcon sx={{ color: '#a98d90 ', marginBottom: '7px' }} /> 
//                 </IconButton>
//               </Typography>
...
//           <CCard style={{ width: '100%', height: 'auto', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }}>
//             <CCardBody>
...
//                           sx={{ marginTop: 2, marginRight: 1, backgroundColor: '#bd2937' }}
//                         >
//                           Save
//                         </Button>
//                         <Button
...
//                           sx={{ marginTop: 2, marginLeft: 2, backgroundColor: '#bd2937' }}
//                         >
//                           New
//                         </Button>
//                       </Grid>
...
function BasicForm() {
  ...
  return (
    <>
   <section className="py-3 py-md-5 py-xl-8" style={{ marginTop: '-55px', marginLeft:'-15px' }}>
  <div className="container">
    <div className="row gy-4 gy-lg-0">
     
      <div className="col-12 col-lg-4 col-xl-3">
        <div className="card widget-card border-light shadow-sm custom-margin" style={{ height: '551px' }} >
      ...
      <div className="col-12 col-lg-8 col-xl-9" style={{  marginLeft:'-15px',width:'855.4px' }}>
    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={12} md={9}>
        ...
        <div className="card widget-card border-light shadow-sm" style={{marginTop:'12px'}}>
          <div className="card-body p-4">
